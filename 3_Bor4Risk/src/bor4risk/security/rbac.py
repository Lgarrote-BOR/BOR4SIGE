"""RBAC 4 roles + CAPACIDADES risk-flavored + SoD estricto + _SOD_EXENTAS."""
...
CAPACIDADES: Dict[str, Dict[str, bool]] = {
    ...
    "gestion_activos":        {"R-MOD-2": True, "R-MOD-4": True},
    "evaluar_amenazas":       {"R-MOD-3": True},
    "registrar_salvaguardas": {"R-MOD-4": True},
    "aprobar_evaluacion":     {"R-MOD-3": True},
    "riesgo.leer":            {"R-MOD-1": True, "R-MOD-2": True, "R-MOD-3": True, "R-MOD-4": True},
    "riesgo.exportar":        {"R-MOD-1": True, "R-MOD-3": True},
...
def evaluar_capa_scope(scope, *, plataforma, roles_modulo, tenant_objetivo=None):
    ...
    reasons.append(f"rol {scope.rol_modulo} sin capacidad sobre '{scope.accion}'")
    return ResultadoCapacidad(False, "DENY", reasons)
