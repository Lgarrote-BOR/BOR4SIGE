# SGI 2.0 - Sistema de Gestión Integrado y Compliance (Webapp)

Esta es la versión Webapp lista para producción del Sistema de Gestión Integrado (SGI 2.0). Permite un despliegue multiusuario en servidor (o local compartido) manteniendo todas las interfaces premium interactivas desarrolladas.
